...
public class CalculatorServiceTest {
    ...
    private final InputView iv = new InputView();

    @Test
    @DisplayName("기본 구분자로 숫자 추출")
    void basic() {
        List<Integer> nums1 = cs.validateInputString("1,2,3");
        List<Integer> nums2 = cs.validateInputString("1,2:3");
    ...
    void custom() {
        ...
        List<Integer> nums1 = cs.validateInputString("//;\\n1;2;3");  // Console 에서 들어오면 \\n 이런식으로 들어옴
